  ...
  return (
    <>
      <Layout>
        <main>
          <Hero />
          <section id="blog-content" className="w-screen h-full py-[5vw]">
            <div className="container-lg ">
            <h2
              data-para-anim
              className="text-[2.5vw] font-light leading-[1.2] text-[#1a1a1a] aeonik mobile:text-center mobile:w-[80%]"
            >
              Reimagining Health, Redefining Care: AMS at Arab Health 2025
            </h2>
            <div className="py-[1vw] fadeUp">
              <p className="content-p py-[1vw]">As we embark on a journey to reshape the future of healthcare, Advanced MedTech Solutions (AMS) is proud to announce its participation in<span className="font-normal"> Arab Health 2025 </span>—the leading healthcare exhibition in the Middle East. This prestigious event will take place from <span className="font-normal">27th to 30th January 2025</span> at the <span className="font-normal">Dubai World Trade Center </span>, and we are thrilled to invite you to be part of this transformative experience.</p>
              <p className="content-p py-[1vw]">At AMS, innovation is at the heart of everything we do. Our dedication to advancing the science of surgery and cardiovascular care drives us to create groundbreaking solutions that empower healthcare professionals worldwide. Arab Health 2025 offers a unique platform to connect, collaborate, and showcase our cutting-edge technologies that are transforming lives across the globe.</p>
            </div>
            ...
            <p className="content-p py-[1vw]">At <span className="font-normal">Booth No. H5.A20</span>, you&apos;ll have the opportunity to:</p>
            <ul className="py-[1vw] list-decimal ml-[2vw] content-p">
              <li>
            ...
            <div className="py-[1vw] fadeUp">
              ...
              <p className="content-p py-[1vw]">Don&apos;t miss the chance to be part of this groundbreaking event. Here are the details you need:</p>
              <ul className="py-[1vw] list-disc content-p">
              ...
              <p className="content-p"><span className="font-normal">Let&apos;s Reimagine Health Together</span></p>
            </div>
            <div className="py-[1vw] fadeUp">
              ...
              <p className="content-p py-[1vw]">See you in Dubai!</p>
