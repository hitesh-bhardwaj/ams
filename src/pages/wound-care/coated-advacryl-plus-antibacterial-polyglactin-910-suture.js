...
const advacrylplus = () => {
  const metadata = {
    title: "Coated Advacryl Plus Antibacterial Polyglactin 910 Suture – Antibacterial Polyglactin Suture",
    description:
      "Explore Coated Advacryl Plus Antibacterial Polyglactin 910 Suture, a Triclosan-coated antibacterial suture designed to reduce surgical site infections.",
    img: "advacrylplus.png",
    alt: "Coated Advacryl Plus Antibacterial Polyglactin 910 Suture – Antibacterial Polyglactin Suture",
