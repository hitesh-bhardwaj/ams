...
const advacrylrapid = () => {
  const metadata = {
    title: "Advacryl Rapid Polyglactin 910 Suture – Fast Absorption Surgical Suture",
    description:
      "Advacryl Rapid offers quick absorption for short-term wound closure needs with high reliability.",
    img: "advacryl-rapid.png",
    alt: "Advacryl Rapid Polyglactin 910 Suture – Fast Absorption Surgical Suture",
