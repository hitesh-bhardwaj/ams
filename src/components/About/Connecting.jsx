  ...
  return (  
    <section className='mobile:py-[10%]' id='connect'>
        <div className='container-lg my-[10%] fadeUp'>
            <div className='p-[3%]  border-[1px]  flex justify-between flex-col items-center rounded-[3.5vw] bg-white/50  relative tablet:rounded-[3vw] mobile:justify-center mobile:text-center mobile:px-[8%] mobile:py-[15%] mobile:rounded-[7vw]'>
                <div className='tablet:w-full tablet:flex tablet:justify-center mobile:w-[75vw]'>
            <h2
data-para-anim className="title-2 aeonik tablet:text-center ">
