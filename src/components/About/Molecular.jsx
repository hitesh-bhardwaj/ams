...
const MolecularCard = ({ symbol, title, description }) => (
  <div className="molecular-card px-[3vw] py-[3vw] bg-white/50 border-[1px] rounded-[40px] border-white glassmorphism mobile:w-[90vw] mobile:h-[90vw] mobile:px-[6vw] mobile:py-[6vw] tablet:w-[50vw] tablet:h-[50vw] tablet:px-[4vw] tablet:py-[4vw] mobile:rounded-[6vw]">
    <div className="w-[6vw] h-[6vw] bg-[#143CA3] text-white flex flex-col items-center justify-center mobile:w-[20vw] mobile:h-[20vw] tablet:w-[10vw] tablet:h-[10vw]">
      <p className="text-[3.5vw] mobile:text-[12.2vw] tablet:text-[5vw]">
        {symbol}
      </p>
      <p
        data-para-anim
        className="text-[0.75vw] mt-[-1vw] mobile:text-[2.5vw] tablet:text-[1.2vw] mobile:mt-[-3vw]"
      >
        {title}
      </p>
    </div>
    <h2
      data-para-anim
      className="text-[2.5vw] mt-[1vw] mb-[1.5vw] font-light mobile:text-[7.4vw] tablet:mt-[3vw] tablet:text-[4vw] mobile:mt-[3vw]"
    >
      {title}
    </h2>
    <p
      data-para-anim
      className="content-p tablet:text-[2.5vw] tablet:leading-[1.3]"
    >
      {description}
    </p>
  </div>
...
const Molecular = () => {
  ...
  return (
    <>
      <section
        className="molecular h-[100vh] overflow-hidden tablet:h-[100vh] mobile:h-[120vh] mobile:py-[15%]"
        id="molecular"
        ...
        <div className="container-sm py-[10%] relative z-[2] w-full h-full">
          <div className="flex items-start justify-between w-full mobile:flex-col mobile:w-[100%] mobile:gap-[10vw]">
            ...
            <div className="molecular-right w-[47%] flex-col gap-y-[2vw] hidden mobile:flex mobile:flex-row mobile:w-[100%] mobile:h-full">
              ...
              <div
                className={`absolute z-[5] bottom-[5%] left-[65%] translate-x-[-65%] border overflow-hidden border-black py-[5vw] px-[5vw] rounded-full next-button cursor-pointer 
                ${
                  activeButton === "next"
                    ? " text-white"
	...
	c-5.858,5.857-5.858,15.355,0,21.213L278.787,150H15c-8.284,0-15,6.716-15,15S6.716,180,15,180z"
              ...
              <div
                className={`absolute z-[5] bottom-[5%] left-[35%] translate-x-[-38%] border border-black overflow-hidden  py-[5vw] px-[5vw] rounded-full prev-button cursor-pointer 
                ${
                  activeButton === "prev"
                    ? " text-white"
                    : "bg-transparent text-[#111111]"
