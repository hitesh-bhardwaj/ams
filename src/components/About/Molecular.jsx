...
const Molecular = () => {
  ...
  return (
    <>
      <section className='molecular h-[100vh] overflow-hidden tablet:h-[90vh] mobile:h-[120vh] mobile:py-[15%]' id='molecular' ref={molecularContainer}>
        ...
        <div className='container-sm py-[10%] relative z-[2] '>
          <div className="flex items-start justify-between w-full mobile:flex-col mobile:w-[100%] mobile:gap-[10vw] ">
            <div className='molecular-left w-[50%] space-y-[2.5vw] mobile:w-[100%] mobile:flex mobile:flex-col mobile:items-center mobile:justify-center mobile:text-center tablet:w-[70%]' ref={molecularLeft}>
