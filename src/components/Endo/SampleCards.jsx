...
const ProductCard = ({ img, heading, rotate }) => {
  return (
    <div className={`${rotate}`}>
      <Link href={"#"}>
        <div
          className={`h-[25vw] w-[26vw] bg-white rounded-[30px] flex flex-col-reverse  items-center justify-between single drop-shadow-sm shadow-sm relative border border-gray-200`}
        >
              ...
              <span className="w-[1.5vw] h-[1.5vw] overflow-hidden flex justify-center items-center pt-[4%]">
                <span className="w-[4vw] h-[1.3vw] flex items-center translate-x-[-30%] group-hover:translate-x-[24%] transition-all ease-in-out duration-300 gap-[0.3vw]">
                  <svg
                    ...
                    className="h-[0.7vw] w-[1.3vw] scale-[0.3] group-hover:scale-[1] transition-all"
                  >
                  ...
                  <svg
                    ...
                    fill="#143CA3"
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-[0.7vw] w-[1.3vw]  group-hover:scale-[0.3] transition-all"
                  >
...
const Slider = () => {
  ...
  return (
    ...
    id="products"
      ref={sliderContainer}
      className={`relative h-screen ${styles.sliderContainer}`}
    >
