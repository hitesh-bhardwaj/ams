...
const PortfolioCard =({img, txt , className})=>{
  return (
    ...
    <div className={` w-[20vw] h-[11.5vw] relative flex justify-center items-center  text-center text-[#fff] cursor-pointer rounded-[40px] overflow-hidden ${className} portfolio-card group mobile:w-[85vw] mobile:h-[120vw] tablet:w-[43vw] tablet:h-[40vw] tablet:rounded-[3vw] fadeup`}>
          ...
          <p
            className=" font-light text-[1.2vw] text-shadow mobile:text-[8vw] mobile:leading-[1.2] tablet:text-[3.5vw] tablet:leading-[1.2]"
          >
           {txt}
          </p>
          </div>
...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio">
      <div  className="container-lg flex flex-col items-center justify-center px-[4%] pt-[10%] pb-[4%] mobile:py-[15%] tablet:px-0">
      <div>
        <h2 data-para-anim className="title-2 aeonik mobile:text-center ">
          Our Advanced Portfolio
        </h2>
      </div>
      <div className="flex items-center justify-between gap-[3vw] mt-[7vw] portfolio-card-container mobile:flex-col mobile:gap-[7vw] mobile:mt-[12vw] tablet:flex-wrap">
