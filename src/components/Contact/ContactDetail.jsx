...
data-para-anim className="aeonik text-[2.5vw] font-light mobile:text-[9vw] mobile:text-center mobile:leading-[1.3] tablet:text-[5vw]">
            ...
            <div className="flex flex-col gap-[2vw] mobile:gap-[10vw] mobile:mt-[7vw] tablet:w-[40%] tablet:gap-[5vw]">
              <div className="flex flex-col gap-[0.5vw] text-[1.25vw] mobile:text-[5.5vw] mobile:w-full mobile:text-center mobile:gap-[4vw] tablet:text-[2.5vw]">
                ...
                <p data-para-anim className="w-[65%] font-light mobile:w-full tablet:w-full">
          ...
          <div className="w-[50%] fadeUp mobile:w-full tablet:w-full">
            <ContactForm />
          </div>
        </div>
        
        <div className="relative z-0 w-[85vw] h-[40vw] ml-[2vw] rounded-[2vw] overflow-hidden fadeUp mobile:h-[160vw] mobile:w-[90vw] mobile:ml-0 mobile:rounded-[7vw] tablet:h-[60vw] tablet:w-[90vw] tablet:ml-0">
          <iframe
