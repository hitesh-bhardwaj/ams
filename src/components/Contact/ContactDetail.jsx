    ...
    <>
      <section className="py-[5%] pb-[8%] relative" id="contactDetail">
        ...
        <div className=" flex justify-between pr-[5vw]">
          <div className="w-[50%] flex flex-col gap-[5vw] mt-[4vw]">
            <div className="flex flex-col gap-[1vw]">
              <h2 data-para-anim className="aeonik text-[2.5vw] font-light">
                Let’s Work Together to Drive Innovation in Healthcare
              </h2>
              <p data-para-anim className="text-[1.25vw] font-light w-[80%] ">
            ...
            <div className="flex flex-col gap-[2vw]">
              <div className="flex flex-col gap-[0.5vw] text-[1.25vw]">
                <h4 data-para-anim>Manufacturing:</h4>
                <p data-para-anim className="w-[65%] font-light">
              ...
              <div className="flex flex-col gap-[0.5vw] text-[1.25vw]">
                ...
                <div className="social-icons flex items-bottom gap-[1vw] fadeUp z-10 mobile:mb-[5vw] mobile:mt-[5vw] mobile:gap-[10vw] fadeUp">
                  <Link
                    href="/#"
          ...
          <div className="w-[50%] fadeUp">
            <ContactForm />
          </div>
        </div>
        
        <div className="relative z-0 w-[85vw] h-[40vw] ml-[2vw] rounded-[2vw] overflow-hidden fadeUp">
          <iframe
