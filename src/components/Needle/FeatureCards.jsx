                  ...
                  {cardData.map((card, index) => (
                    ...
                    >
                      <div className="w-full h-full relative px-[7vw] py-[5vw] tablet:px-[4vw]">
                        ...
                        >
                         <p className="mt-[-2vw] font-thin tablet:mt-[-1.2vw]">+</p>
                        </span>
                        <h4
                          data-para-anim
                          className={`text-[8vw] aeonik font-light tablet:text-[4vw] ${
                            activeMobileCardIndex === index ? "hidden" : ""
                          }`}
                        >
                          {card.title}
                        ...
                        <p
                          data-para-anim
                          className={`text-[#143CA3] text-[5vw] font-light tablet:text-[2.5vw] ${
                            activeMobileCardIndex === index ? "hidden" : ""
                          }`}
                        >
                          {card.description}
                        ...
                        <div
                          className={`w-[80vw] h-full absolute tablet:w-[50vw] ${
                            index >= 1 ? "top-[20%] left-[5%]" : "top-0 left-0"
                          }`}
                        >
                          <Image
                            src={card.imageSrc}
