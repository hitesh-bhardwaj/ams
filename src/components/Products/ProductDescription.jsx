...
const ProductCard=({img,title,para})=>{
    return(
    <div className="flex flex-col justify-between items-center w-[28vw] h-[16vw] product-description-card border relative rounded-[40px] glassmorphism mobile:w-[70vw] mobile:h-[75vw] mobile:flex-shrink-0">
    <div className="absolute top-10 right-10 w-[4.5vw] h-[4.5vw] flex justify-end items-center mobile:h-[20vw] mobile:w-[20vw]  mobile:right-[35%] ">
    ...
    <div className="absolute bottom-10 left-10 flex flex-col justify-start gap-[1vw] mobile:justify-center mobile:text-center">
      <p className="text-[1.65vw] font-medium mobile:text-[7.5vw]">{title}</p>
      <p className="text-[1.65vw] font-light mobile:text-[5vw]">{para}</p>
    </div>
  </div>
    )
...
const ProductDescription = ({card1,card2,card3,card4,card5,card6}) => {
  ...
  return (
    <>
      <section>
        <div className="w-screen h-screen container-lg mobile:h-[70%] mobile:px-[3vw] mobile:py-[3vw] mobile:container-sm">
          <div className="flex flex-col items-center justify-center gap-[5vw] overflow-hidden">
            ...
            <div className="flex flex-wrap items-center gap-[3vw] product-description-card-container mobile:hidden">
