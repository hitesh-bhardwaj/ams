...
const Hero = ({ heading, tagline, para1, src,bgimg, para2,margin, className = "" }) => {
  return (
    <>
      <section className="hero tablet:mb-0 tablet:pr-[3%] w-screen overflow-hidden h-screen shadow-md drop-shdow-sm mobile:shadow-none py-[2%] tablet:h-[70vh]" id="hero">
...
data-para-anim
            ...
            <div className="absolute right-0 top-[10%] flex flex-col items-center justify-end  mobile:flex-col-reverse mobile:right-0 mobile:top-[25%] tablet:top-[50%]">
              ...
              <div className={`mobile:mt-[7vw] mt-[-5vw] ${margin} ml-[-15vw] mobile:ml-0`}>
                <p data-para-anim className="max-w-[35vw]  text-[1.45vw] leading-[1.2] font-light mobile:text-[5vw] mobile:max-w-[75vw] mobile:py-[10%] mobile:mb-[20%] tablet:text-[2.5vw] tablet:max-w-[52vw] tablet:mt-[-5vw] tablet:text-left">
                  {para2}
                </p>
              </div>
            </div>
