      ...
      >
        <div className="w-screen h-screen container-lg z-[5] mobile:h-full tablet:h-full">
          <div className="w-full h-full flex flex-col items-center justify-center pb-[5vw] tablet:justify-start mobile:justify-start mobile:h-fit ">
            ...
            <div className=" h-full w-full absolute left-[10%] top-[20%]  mobile:h-full   pt-[10vw] mobile:pb-[10%] mobile:left-0 fadeUp tablet:h-full tablet:pb-[5%] tablet:top-[15%]">
              <div className="h-[38vw] w-[50vw] relative mobile:w-[150vw] mobile:h-[80vw] mobile:left-[-15%]  mobile:top-0 tablet:w-[80vw] tablet:h-[60vw] tablet:scale-[1.2]">
                <Image
            ...
            <div className=" text-[1.25vw] absolute top-[20%] left-[65%] h-[50vw] py-[5.4%] space-y-[25%] mobile:static mobile:space-y-0 mobile:flex mobile:flex-col mobile:gap-[8vw] mobile:justify-center mobile:mt-[50vh] mobile:w-full z-[10] mobile:h-fit mobile:text-[6vw] tablet:static tablet:space-y-0 tablet:flex tablet:flex-col tablet:justify-center tablet:items-center tablet:mt-[40vh] tablet:w-full tablet:h-fit tablet:gap-[5vw] tablet:text-[4vw]">
              <div className=" mobile:flex mobile:justify-center tablet:translate-y-0 tablet:ml-0 tablet:flex tablet:justify-center">
              ...
              <div className="translate-y-[-45%] ml-[20%] mobile:translate-y-0 mobile:ml-0 mobile:flex mobile:justify-center tablet:translate-y-0 tablet:ml-0 tablet:flex tablet:justify-center">
              ...
              <div className="translate-y-[-55%] ml-[30%] mobile:translate-y-0 mobile:ml-0 mobile:flex mobile:justify-center tablet:translate-y-0 tablet:ml-0 tablet:flex tablet:justify-center">
              ...
              <div className="translate-y-[-95%] ml-[30%] mobile:translate-y-0 mobile:ml-0 mobile:flex mobile:justify-center tablet:translate-y-0 tablet:ml-0 tablet:flex tablet:justify-center">
              ...
              <div className="translate-y-[-120%] ml-[20%] mobile:translate-y-0 mobile:ml-0 mobile:flex mobile:justify-center tablet:translate-y-0 tablet:ml-0 tablet:flex tablet:justify-center">
              ...
              <div className="translate-y-[-150%] mobile:translate-y-0 mobile:ml-0 mobile:flex mobile:justify-center tablet:translate-y-0 tablet:ml-0 tablet:flex tablet:justify-center">
