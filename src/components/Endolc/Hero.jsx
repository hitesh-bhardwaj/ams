  ...
  return (
    <>
      <section className="hero mb-[10%]  tablet:pr-[3%] relative" id="advastap-hero">
        <div className="px-[10%]  hero-container overflow-hidden w-screen  mobile:mt-[30%] tablet:px-[5%] mobile:px-[8%]">
          <div className="  flex flex-col h-screen w-full justify-center items-start  mobile:h-[85vh] mobile:flex-col mobile:justify-start mobile:text-center mobile:gap-[2vw] tablet:h-[60vh]">
            <div className=" mobile:w-full mobile:h-fit mobile:flex mobile:flex-col mobile:gap-0">
              ...
              <div className="flex items-center justify-end mt-[-0.5vw] w-[75%] mobile:justify-center mobile:text-center mobile:ml-0 ">
        ...
        <div className="absolute h-[100%] w-[100%] top-0 right-[-15%] z-[-1]">
