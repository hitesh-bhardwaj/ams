    ...
    <>
      <section className="overflow-hidden relative mobile:py-[10%] " id="precision">
        <div className="w-screen h-full container-lg  overflow-hidden precision-container mobile:h-[120vh] tablet:h-[70%]">
          <div className="w-full h-full flex flex-col items-center justify-center relative gap-[5vw] mobile:static">
            ...
            <div className="flex items-center justify-evenly gap-[1vw] w-full mobile:flex-col mobile:gap-[10vw]">
             <div className="h-[40vw] w-[80%] relative left-[-15%] mobile:absolute mobile:top-[35%] mobile:left-0 mobile:w-[170vw] mobile:h-[50vh] tablet:w-full tablet:left-0 tablet:h-[60vw]">
                ...
                <div className="absolute top-[30%] right-[-20%] mobile:top-[-25%] mobile:right-[48%] tablet:right-0">
        ...
        <div className="absolute h-[100%] w-[130vw] bottom-0 mobile:left-0 z-[-1]">
            ...
            <span className="w-[26vw] h-[2px] bg-black/50 absolute top-[60%] left-[28%] rotate-[-25deg] lineDraw mobile:w-[60vw] mobile:rotate-[80deg] mobile:top-[48%] mobile:left-[30%] tablet:left-[38%] tablet:w-[17vw] "></span>
            <span className="w-[28vw] h-[2px] bg-black/50 absolute top-[80%] left-[24%] lineDraw mobile:rotate-[110deg] mobile:top-[75%] mobile:left-[28%] tablet:w-[35vw] tablet:left-[33%]"></span>
      </section>
    </>
  );
};
