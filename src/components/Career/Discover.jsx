...
const Discover = () => {
  imgAnim()
  return (
   <section id='discover' className='mobile:py-[15%] tablet:py-[7%]'>
    <div className='container-lg px-[5%] flex justify-between mobile:flex-col mobile:px-[4%] border border-gray-200 glassmorphism mobile:py-[15%] mobile:pb-[15%] rounded-[3vw] mobile:rounded-[6vw] py-[5vw]'>
