...
const Hero = () => {
  ...
  return (
    <section className=" mb-[5%] hero-container" id="hero">
      <div className="w-[100vw] h-[100vh] relative overflow-hidden tablet:h-[80vh] mobile:pt-[20vw] mobile:h-fit">
        ...
        <LazyVideo
          ...
          className='w-full h-full object-cover left-0 top-0 absolute mobile:static mobile:h-[60vw]'
        />
