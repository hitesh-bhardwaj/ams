...
data-para-anim className="title-2 aeonik w-[60%] text-center mobile:w-[90%] tablet:w-[70%]">
          ...
          <div className="w-full h-full flex gap-[2vw] mobile:flex-col mobile:gap-[7vw] ">
            <div className="w-[50%] h-[40vw] glassmorphism rounded-[2.5vw] px-[5vw] py-[3vw] pb-[10vw] relative flex flex-col gap-[3vw] border font-light mobile:w-[90vw] mobile:h-[150vw] mobile:rounded-[9vw] mobile:justify-end overflow-hidden fadeUp tablet:h-[60vw] tablet:justify-between">
              <h4 data-para-anim className="aeonik text-[2.5vw] mobile:text-[8vw] mobile:text-center mobile:leading-[1.2] tablet:text-[3.5vw] ">
              ...
              <div className="pl-[1.5vw] flex flex-col gap-[1.5vw] mobile:gap-[4vw] mobile:mt-[5vw] tablet:text-[2.8vw] text-[1.7vw] z-[10]  ">
                <div className="">
                  <p data-para-anim className=" aeonik leading-[1.2] mobile:text-[6vw] mobile:text-center w-[40%] mobile:w-full tablet:w-full ">SECURITY
                  </p>
                  <p data-para-anim className=" aeonik leading-[1.2] mobile:text-[6vw] mobile:text-center w-full mobile:w-full">Swage Integrity.</p>
                </div>
                <div className="">
                  <p data-para-anim className=" aeonik leading-[1.2] mobile:text-[6vw] mobile:text-center w-[40%] mobile:w-full tablet:w-full">STRENGTH
                ...
                <div className="">
                  <p data-para-anim className=" aeonik leading-[1.2] mobile:text-[6vw] mobile:text-center w-[40%] mobile:w-full tablet:w-full">SHARPNESS
