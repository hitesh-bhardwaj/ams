  ...
  return (
    <section className="genesis mobile:h-full overflow-hidden pt-[12%] tablet:pt-[15%] mobile:pt-[25%]" id="genesis">
      <div className="container-lg mx-auto flex items-center justify-center flex-col relative pb-[7.5vw] tablet:pb-0 mobile:pb-0">
        <div className="genesis-card w-[80%] border-[1px] relative border-[#DADADA] z-[1] bg-white/70 backdrop-blur-sm rounded-[2.5vw] px-[1%] py-[5%] mobile:py-[15%] mobile:w-full tablet:w-[90%]">
