...
const Genesis = ({content,sParaWidth , bParaWidth}) => {
  ...
  return (
    <section className="genesis relative mobile:h-[140vh] " id="genesis">
      <div className="container-lg  ml-auto mr-auto flex items-center justify-center flex-col pt-[5%] pb-[10%] mobile:py-[10%] mobile:h-full">
        <div className="genesis-card w-[80%] border-[1px] border-[#DADADA] z-[1] bg-white  rounded-[50px] px-[1%] py-[5%] glassmorphism mobile:py-[15%] mobile:w-[95%]">
          ...
          <div className="genesis-text flex w-full justify-center gap-x-[4vw] mt-[4vw] mobile:flex-col mobile:px-[4vw] mobile:gap-[7vw] mobile:py-[4vw] tablet:gap-x-[4vw] tablet:flex tablet:flex-col tablet:px-[4vw] tablet:gap-[5vw]">  
            <div className={`w-[30%] content-p leading-[1.4] mobile:w-full mobile:text-center tablet:w-full tablet:text-[2.5vw] tablet:leading-[1.3] ${sParaWidth}`}>
        ...
        <div className="genesis-image mobile:absolute mobile:left-0 mobile:bottom-0">
            <div className="w-[90vw] h-[30vw] absolute bottom-[8%] left-[50%] translate-x-[-50%] overflow-hidden rounded-[50px] tablet:h-[50vw] mobile:h-[140vh] mobile:w-screen mobile:overflow-hidden mobile:rounded-none mobile:bottom-0 mobile:left-0 mobile:translate-x-0">
            <Image
