...
const PortfolioSwiper = () => {
  ...
  return (
    <section>
      <div className=" w-full mb-[10%] ml-[10%] mt-[-15%] ">
        <div className="text-[1.25vw] text-[#2A2A2A] font-light rotate-[-90deg] relative left-[-50%] portfolio-text flex items-center gap-[2vw] ">A Partner in Your Success</div>
       <div className="mt-[10%] ">
       <Swiper
        slidesPerView={1}
        spaceBetween={10}
