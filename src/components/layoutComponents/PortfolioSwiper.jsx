...
const PortfolioCard = ({ src, heading, para }) => {
  return (
    <div className="">
      <div className="w-[85vw] h-[50vw] relative rounded-[10px] mobile:w-[100vw] mobile:h-[80vh] tablet:h-[70vw]">
        ...
        <div className="absolute top-[30%] left-[10%] flex flex-col gap-[2vw]  mobile:top-[15%] mobile:left-[0%] mobile:items-center mobile:justify-center mobile:text-center tablet:top-[10%]">
          <h2 className="text-[#ffffff] text-[2.8vw] font-light text-shadow mobile:text-[8.4vw] tablet:text-[5vw]">{heading}</h2>
          <p className="text-[#ffffff] text-[1.4vw] font-extralight w-[50%] text-shadow mobile:text-[4.2vw] tablet:text-[3vw] tablet:w-[70%]">{para}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section id="hernia-swiper" className="overflow-x-hidden">
      <div className="w-full mb-[5%] ml-[10%] py-[10%] relative h-full mobile:ml-[0%]">
        <div className="text-[1.25vw] text-[#2A2A2A] font-light rotate-[-90deg] absolute left-[-52%] portfolio-text flex items-center gap-[2vw] w-full top-[8%] mobile:hidden tablet:hidden">
