        ...
        <div className="px-[12%] relative mobile:px-[5%]">
          <div className="flex h-dvh w-full flex-col justify-center items-start tablet:h-[80vh] mobile:justify-start mobile:pt-[10vw]">
            <div className={`w-[90%] mobile:w-full tablet:w-full`}>
              ...
              <p className={` max-w-[30vw] mt-[3vw] mb-[4vw] content-p mobile:text-center  mobile:max-w-[100%] tablet:max-w-[60vw] mobile:!drop-shadow-none mobile:my-[7vw] tablet:text-[2.5vw] `}>
                <span data-para-anim className={`text-[#111111] leading-[1.4] mobile:text-[#111111]`}>
                  {content}
                </span>
              </p>
            </div>
