...
const SurgicalOutcomes = () => {
  return (
    <section id="surgical-outcomes" className="relative h-screen mobile:h-full mobile:py-[15%] mobile:pb-[35%] py-[8%] tablet:py-[10%] tablet:h-[80vh]">
      <div className="w-screen h-full container-lg">
        <div className="w-full h-full flex flex-col items-start justify-start pb-[2vw] mobile:h-fit tablet:py-0 tablet:gap-[5vw]">
          ...
          <div className=" flex items-start justify-start gap-[3vw] z-[5] w-full my-[5vw] h-full tablet:flex-wrap tablet:justify-center">
            <div className="glassmorphism w-[21vw] h-[16.5vw]  rounded-[2vw] border border-white p-[2vw] tablet:w-[35vw] tablet:h-[25vw]">
            ...
            <div className="glassmorphism w-[21vw]  h-[16.5vw] rounded-[2vw] z-[5] border border-white p-[2vw] tablet:w-[35vw] tablet:h-[25vw]">
            ...
            <div className="glassmorphism w-[21vw]  h-[16.5vw]  rounded-[2vw] border border-white p-[2vw] z-[5] tablet:w-[35vw] tablet:h-[25vw]">
