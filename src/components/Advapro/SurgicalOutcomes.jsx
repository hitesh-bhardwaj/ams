  ...
  return (
    <section id="surgicalOutcomes" className="relative h-[55vw] w-screen overflow-hidden mobile:h-full mobile:py-[15%]  py-[8%] tablet:py-[10%] tablet:h-[80vh]">
      <div className="w-full h-full container-lg">
        <div className="w-full h-full flex flex-col items-start justify-start pb-[5vw] mobile:h-fit tablet:py-0 tablet:gap-[5vw]">
          <div className=" text-center flex items-center justify-center w-full mobile:mb-[10vw] mobile:left-[22%] mobile:w-[60%] mobile:top-[5%]">
            <h2
             data-para-anim
          ...
          <div className=" flex items-start justify-start gap-[2vw] z-[5] w-full mt-[5vw] h-full tablet:flex-wrap mobile:flex-col mobile:items-center mobile:justify-center mobile:gap-[7vw] mobile:mt-[140vw]  tablet:justify-center tablet:gap-[5vw] tablet:mt-[45vw]">
            <div className="glassmorphism card-up w-[22vw] h-[15vw]  rounded-[2.5vw] border border-white p-[2vw] tablet:w-[38vw] tablet:h-[25vw] mobile:rounded-[9vw] mobile:w-[80vw] mobile:h-[50vw] mobile:p-[4vw]">
            ...
            <div className="glassmorphism card-up w-[22vw]  h-[15vw] rounded-[2.5vw] z-[5] border border-white p-[2vw] tablet:w-[38vw] tablet:h-[25vw] mobile:rounded-[9vw] mobile:w-[80vw] mobile:h-[50vw] mobile:p-[4vw]">
            ...
            <div className="glassmorphism card-up w-[22vw]  h-[15vw]  rounded-[2.5vw] border border-white p-[2vw] z-[5] tablet:w-[38vw] tablet:h-[25vw] mobile:rounded-[9vw] mobile:w-[80vw] mobile:h-[50vw] mobile:p-[4vw]">
