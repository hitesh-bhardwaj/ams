        ...
        <div className="w-screen h-[70vw] container-lg  mobile:h-[150vh] tablet:h-[95vh] ">
          <div className="w-full h-full flex flex-col items-center justify-center relative py-[5vw] mobile:justify-between ">
            ...
            <div className="absolute w-full h-full flex flex-col items-center justify-center mobile:justify-end mobile:pb-[10%]">
              <div className="h-[50vw] w-[80vw] relative scale-[1] left-[10%] top-[15%] mobile:w-[150vw] mobile:top-[30%] mobile:left-[-30%] mobile:absolute  tablet:w-[100vw] pointer-events-none tablet:rotate-45 tablet:top-[15%] tablet:left-[10%] tablet:scale-[1.2]">
                <Image
