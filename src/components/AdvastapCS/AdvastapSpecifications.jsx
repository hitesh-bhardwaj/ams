      ...
      >
        <div data-lenis-prevent  className="w-full text-[1.25vw] font-light py-[2vw]  text-[#4A4A4A] overflow-y-auto mobile:py-[5vw] mobile:text-[4.5vw] tablet:text-[2.5vw]  mobile:overflow-x-scroll  mobile:overflow-scroll mobile:mt-[7vw] ">
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw] ">
            <div className="flex-[0.5] p-[1vw] font-light tablet:w-[20vw]">Product Code</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw]">
              <div className="p-[1vw]   mobile:w-[80vw]">3 Row</div>
              <div className="p-[1vw]   w-[20vw] mobile:w-[80vw]">3 Row</div>
            </div>
          </div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw]">
              <div className="p-[1vw]   mobile:w-[80vw]">36</div>
              <div className="p-[1vw]   w-[20vw] mobile:w-[80vw]">45</div>
            </div>
          </div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex  justify-between mobile:w-[100vw]">
              <div className="p-[1vw]  mobile:w-[80vw]">4.8mm</div>
              <div className="p-[1vw]  w-[20vw] mobile:w-[80vw]">5.0mm</div>
            </div>
          </div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw] ">
              <div className="p-[1vw]   mobile:w-[80vw]">2.15÷0.2mm</div>
              <div className="p-[1vw]   w-[20vw] mobile:w-[80vw]">2.25£0.2mm</div>
            </div>
          </div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between  mobile:w-[100vw]">
              <div className="p-[1vw]   mobile:w-[80vw]">15 CC</div>
              <div className="p-[1vw]   w-[20vw] mobile:w-[80vw]">19 CC</div>
            </div>
          </div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw] ">
              <div className="p-[1vw]  mobile:w-[80vw]">20mm</div>
              <div className="p-[1vw]  w-[20vw] mobile:w-[80vw]">22mm</div>
            </div>
          </div>
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            <div className="flex-[0.5] p-[1vw]">Quantity/Box</div>
            <div className="flex-1 flex justify-between mobile:w-[100vw] ">
              <div className="p-[1vw]   mobile:w-[80vw]">01</div>
