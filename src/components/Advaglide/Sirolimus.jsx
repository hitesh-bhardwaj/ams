      ...
      <div className='container-lg'>
        ...
        <div className='w-[45vw] h-[30vw] rounded-[4vw] p-[4vw] py-[6vw] flex flex-col glassmorphism-light justify-between border border-gray-400/60 fadeUp mobile:w-[90vw] mobile:h-[160vw] overflow-hidden mobile:justify-end mobile:items-center mobile:pb-[20vw] fadeUp'>
            <div className='w-full mobile:flex mobile:flex-col mobile:items-center'>
                ...
                <h3 data-para-anim className='text-[4vw] leading-[1.2] aeonik font-light mobile:text-[11vw] mobile:text-center mobile:mb-[3vw]'>ADVA PRO</h3>
            <p className='text-[1.6vw] capitalize font-extralight mb-[1.5vw] mobile:text-[5vw] mobile:text-center mobile:mb-[15vw] mobile:w-[80%]'>sirolimus drug eluting Stent system</p>
                </div>
