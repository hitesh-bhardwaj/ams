...
data-para-anim
        ...
        <div className="absolute w-[70vw] h-[35vw] scale-[1.7] left-[5%] top-[10%] mt-[5vw] fadeUp mobile:w-[140vw] mobile:h-[140vw] mobile:left-[-55%] mobile:top-[30%] mobile:rotate-[-40deg] fadeUp tablet:top-[30%] tablet:w-[120vw] tablet:h-[50vw] tablet:left-[-30%] tablet:rotate-[-30deg]">
          <Image
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute top-[43%] right-[23.5%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:top-[40%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute top-[49%] right-[32.5%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:top-[50%] mobile:right-[15%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute top-[58%] right-[39%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:right-[30%] mobile:top-[60%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute bottom-[27%] left-[49%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:left-[35%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute bottom-[23%] left-[40%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:left-[45%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute bottom-[22%] left-[29%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] tablet:w-[5vw] tablet:h-[5vw]"
