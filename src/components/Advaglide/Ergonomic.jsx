...
data-para-anim
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute top-[36%] right-[28.5%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:top-[40%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute top-[47%] right-[40.5%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:top-[50%] mobile:right-[15%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute top-[54%] right-[44%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:right-[30%] mobile:top-[60%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute bottom-[29%] left-[41%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:left-[35%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute bottom-[25%] left-[31%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] mobile:left-[45%] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <span
          className="w-[2vw] h-[2vw] bg-white/30 rounded-full absolute bottom-[25%] left-[24%] flex justify-center items-center cursor-pointer border mobile:w-[8vw] mobile:h-[8vw] tablet:w-[5vw] tablet:h-[5vw]"
        ...
        <p
          className={`text-[1.4vw] font-light absolute top-[40%] right-[40%] text-[#4a4a4a] transition-opacity duration-300 mobile:text-[5vw] tablet:text-[3.5vw] ${
        ...
        <p
          className={`text-[1.4vw] font-light absolute top-[62%] left-[24%] text-[#4a4a4a] transition-opacity duration-300 mobile:text-[5vw] tablet:text-[3.5vw] ${
        ...
        <p
          className={`text-[1.4vw] font-light absolute top-[60%] left-[20%] text-[#4a4a4a] transition-opacity duration-300 mobile:text-[5vw] tablet:text-[3.5vw] ${
