      ...
      >
        ...
        >
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw]">
              <div className="p-[1vw]   mobile:w-[80vw]">Titanium Grade 1</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw] ">
              <div className="p-[1vw]   mobile:w-[80vw]">B Form</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw] ">
              <div className="p-[1vw]   mobile:w-[80vw]">3 years</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw]">
            ...
            <div className="flex-1 flex justify-between mobile:w-[100vw] ">
              <div className="p-[1vw]   mobile:w-[80vw]">Single-use</div>
              <div className="p-[1vw]   w-[20vw] mobile:w-[80vw]">
                Single-use
              </div>
            </div>
