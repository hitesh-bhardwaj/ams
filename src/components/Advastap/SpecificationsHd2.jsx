    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="flex w-full border-b border-[#DADADA] gap-[5vw] mobile:w-[180vw] tablet:w-[100vw]">
            <div className="w-[20vw] p-[1vw] pb-0 mobile:w-[70vw] tablet:w-[30vw] capitalize">Pin material</div>
            <div className=" flex justify-start  gap-[5vw] mobile:w-[100vw]">
          ...
          <div className="flex w-full border-b border-[#DADADA] gap-[5vw] mobile:w-[180vw] tablet:w-[100vw]">
            <div className="w-[20vw] p-[1vw]  pb-0 mobile:w-[70vw] tablet:w-[30vw] capitalize">Staple height</div>
            <div className=" flex  justify-start  gap-[5vw] mobile:w-[100vw]">
          ...
          <div className="flex w-full border-b border-[#DADADA] gap-[5vw] mobile:w-[180vw] tablet:w-[100vw]">
            <div className="w-[20vw] p-[1vw]  pb-0 mobile:w-[70vw] tablet:w-[30vw] capitalize">Closed staple shape</div>
            <div className=" flex justify-start  gap-[5vw] mobile:w-[100vw] ">
          ...
          <div className="flex w-full border-b border-[#DADADA] gap-[5vw] mobile:w-[180vw] tablet:w-[100vw]">
            <div className="w-[20vw] p-[1vw]  pb-0 mobile:w-[70vw] tablet:w-[30vw] capitalize">Shelf life</div>
            <div className=" flex justify-start  gap-[5vw] mobile:w-[100vw] ">
