  ...
  return (
   ...
   <section>
    <div className='w-screen h-screen bg-[#020F20] overflow-hidden mobile:h-[85vh] tablet:h-[85vh]'>
        <div className='w-screen  bg-white relative  flex h-[80%] flex-col-reverse justify-between items-start pt-[4vw] mobile:py-[10vw] mobile:h-[70vh] tablet:h-[70vh]'>
            <div className='w-full h-full scale-[1.7]  left-[-5%] relative hd-container top-[15%] mobile:w-full mobile:-rotate-90 mobile:scale-[1] mobile:top-[20%] tablet:left-0 tablet:scale-[1]'>
            <Image 
