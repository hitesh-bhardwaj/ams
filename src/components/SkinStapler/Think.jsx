          ...
          <div className="w-full h-full">
            <div className="absolute left-[10%] top-[35%] flex flex-col items-start justify-center gap-[1.5vw] mobile:static mobile:gap-[10vw] tablet:gap-[4vw]">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center justify-center gap-[2vw] px-[1vw] pr-[3vw] rounded-[1vw] group cursor-pointer relative mobile:flex-col mobile:items-center mobile:w-full mobile:rounded-[4vw] think-content hover:border hover:border-[#3A87C8]"
                >
                  {/* SVG Border */}
