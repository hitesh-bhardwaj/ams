    ...
    return (
        <>
            <section className="pt-[0] pb-[10%] mobile:pb-[20%] tablet:pb-[8%]" id="facility">
                <div className=" ">
                <div className="group container-lg virtual rounded-[3vw] flex items-center justify-between px-[6%] py-[5%] bg-white/50  border border-gray-200hover:bg-white hover:shadow-xl duration-300 mobile:flex-col-reverse mobile:rounded-[9vw] tablet:flex tablet:flex-col tablet:justify-between tablet:gap-[5vw] tablet:rounded-[4vw] tablet:py-[5%]">
