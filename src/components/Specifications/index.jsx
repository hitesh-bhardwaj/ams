  ...
  return (
    <>
      <section id="specifications" className="relative ">
        <div className="w-screen h-[25vh]  flex overflow-hidden items-center pt-[3vw] pl-[10vw]  tablet:h-[15vh] mobile:h-[18vh] mobile:mb-[-5vh]">
          <div className="flex items-center justify-center">
            <button onClick={openModal} className="flex items-center">
              <div className={`text-white aeonik text-[2.5vw] uppercase mt-[-3vw] leading-[1.2] tracking-widest ${textclass} mobile:text-[4.8vw] tablet:text-[5vw] mobile:mt-[-5vh]`}>
                <p>Specifications</p>
              </div>
        ...
        {isModalOpen && (
          ...
          <div className="fixed  w-screen h-screen top-0 left-0  flex items-center justify-center z-[999] bg-opacity-50 bg-black/50 "  ref={modalRef}>
            <div  data-scroll-prevent className="bg-[#efefef]  border  border-white rounded-[1.5vw] p-[3vw] w-[80vw] max-h-[95vh]  modal-no-scrollbar  mobile:max-h-[95vh] mobile:py-[7vw] mobile:w-[95vw]">
              <div
                onClick={closeModal}
