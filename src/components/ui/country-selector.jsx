  ...
  return (
    <div ref={ref}>
      <div className="mt-1 relative">
        <button
          type="button"
          className="relative h-[3vw] w-full border-b border-[#a1a1a1] tablet:h-[5.5vw] mobile:h-[10vw] bg-[#fdfdfd] px-3 pt-2 lg:text-[1vw] text-[1.2vw] tablet:text-[2.2vw] mobile:text-[4vw] aeonik font-light placeholder:text-gray-300 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
        ...
        >
          ...
          {open && (
            <ul
              data-lenis-prevent
              className="absolute z-10 mt-2 w-full bg-white shadow-lg max-h-80 rounded-[0.5vw] text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm"
              tabIndex={-1}
              role="listbox"
              aria-labelledby="listbox-label"
             ...
             <div className="sticky top-0 z-10 bg-white">
                <li className=" text-gray-900 cursor-default select-none relative py-2 px-3 flex items-center gap-x-4">
                    ...
                    <input
                        ...
                        name="search"
                        autoComplete={"off"}
                        className="block w-full rounded-md focus:outline-none font-light aeonik"
                  ...
                  COUNTRIES.filter((country) =>
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="font-light aeonik truncate">
                          {value.title}
                        </span>
