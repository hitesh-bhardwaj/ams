...
const ProductCarousel = () => {
  ...
  return (
    <section id="productCarousel" className="relative w-screen h-[110vh] overflow-hidden  mobile:h-[150vh] mobile:py-[20vw] bg-white/30 py-[10vw] mt-[7%]  mobile:mb-[15%] tablet:h-[70vh] ">
      <div className="w-full h-full flex items-center justify-between pl-[5vw] mobile:flex-col-reverse tablet:flex-col-reverse">
        ...
        <div className="w-[50vw] h-[110%] overflow-hidden mobile:w-full mobile:h-[30%] mobile:mt-[30%] tablet:mt-[10%] tablet:w-full">
          ...
          <div
            className={`px-[1.6vw] py-[1.6vw] top-[25%] right-[32%] absolute z-[5] mobile:bottom-auto mobile:right-auto mobile:top-[45%] mobile:left-[39%] translate-x-[-38%]  tablet:top-[10%] bg-white/50 overflow-hidden  mobile:p-[5vw] tablet:p-[2vw] rounded-full prev-button cursor-pointer  mobile:block group hover:text-white tablet:right-[10%]
                ${
                  activeButton === "prev"
                    ? " text-white"
                    : "bg-transparent text-[#111111]"
      ...
      <div className="absolute w-[46vw] h-[90vh] top-[10%] right-0 z-[-1] mobile:h-[50vh] mobile:w-[90vw] mobile:top-[10%] tablet:hidden">
        <Image
