...
const PrimaryButton = ({link, btnText, className}) => {
    return(
        ...
        <Link href={link} className="min-w-[11vw] w-fit h-fit group text-center relative py-[0.9vw] px-[3vw] rounded-full group bg-[#9E7BDF] overflow-hidden block mobile:min-w-[40vw] mobile:py-[3vw]">
