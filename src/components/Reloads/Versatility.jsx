...
const Versatility = () => {
  ...
  return (
    <section className="overflow-hidden py-[2%] mobile:py-[10%] relative" id="versatility">
      ...
      <div className="text-1 absolute bottom-[30%] left-[40%] mobile:bottom-[10%] mobile:left-[10%] opacity-0">
        <p
          data-para-anim
          className="text-[1.67vw] font-light mobile:text-[6vw] mobile:w-[50%] mobile:text-center mobile:leading-[1.2] tablet:text-[3vw]"
        >
      ...
      <div className="text-2 absolute top-[40%] left-[15%] mobile:top-[55%] tablet:top-[45%] opacity-0">
        <p
          data-para-anim
          className="text-[1.67vw] font-light mobile:text-[6vw] mobile:w-[60%] mobile:text-center tablet:text-[3vw]"
        >
          <span>Drop shaped anvil pockets</span>
        </p>
      </div>
      <div className="text-3 absolute right-[25%] top-[45%] opacity-0 mobile:static mobile:w-[80vw] mobile:h-[30vw] mobile:mt-[15vw] mobile:flex mobile:flex-col mobile:gap-[4vw] tablet:w-[35vw] tablet:top-[30%]">
        <Image
        ...
        <p
          data-para-anim
          className="text-[1.67vw] font-light mobile:text-[7vw] mobile:text-center tablet:text-[3vw] tablet:text-center"
        >
          Stepped cartridge face
        </p>
      </div>
      <span className="dot-1 absolute top-[57%] left-[39.5%] w-[2vw] h-[2vw] bg-white/30 rounded-full flex justify-center items-center mobile:w-[8vw] mobile:h-[8vw] mobile:right-[15%] mobile:left-auto tablet:w-[3.5vw] tablet:h-[3.5vw] tablet:top-[71%] tablet:left-[50%] z-[5]">
        <span className="w-[0.8vw] h-[0.8vw] bg-white rounded-full mobile:w-[4vw] mobile:h-[4vw] tablet:w-[2vw] tablet:h-[2vw]"></span>
      </span>
      <span className="dot-2 absolute top-[52%] left-[31%] w-[2vw] h-[2vw] bg-white/30 rounded-full flex justify-center items-center mobile:w-[8vw] mobile:h-[8vw] mobile:right-[30%] mobile:top-[60%] mobile:left-auto tablet:w-[3.5vw] tablet:h-[3.5vw] tablet:top-[61%] tablet:left-[70%] z-[5]">
        <span className="w-[0.8vw] h-[0.8vw] bg-white rounded-full mobile:w-[4vw] mobile:h-[4vw] tablet:w-[2vw] tablet:h-[2vw]"></span>
      </span>
      <span className="dot-3 absolute top-[52%] left-[47%] w-[2vw] h-[2vw] bg-white/30 rounded-full flex justify-center items-center mobile:w-[8vw] mobile:h-[8vw] mobile:right-[17%] mobile:top-[50%] mobile:left-auto tablet:w-[3.5vw] tablet:h-[3.5vw] tablet:top-[60%] tablet:left-[45%] z-[5]">
        <span className="w-[0.8vw] h-[0.8vw] bg-white rounded-full mobile:w-[4vw] mobile:h-[4vw] tablet:w-[2vw] tablet:h-[2vw]"></span>
      </span>
    </section>
  );
