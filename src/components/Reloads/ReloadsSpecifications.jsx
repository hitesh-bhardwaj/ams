...
const ReloadsSpecifications = () => {
  return (
   <>
      ...
      >
        <div className="w-full text-[1.25vw] font-light mt-[3vw] text-[#4A4A4A] mobile:text-[4.5vw] tablet:text-[2.5vw] mobile:overflow-x-auto mobile:overflow-scroll mobile:mt-[7vw]">
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw] ">
            <div className="flex-[0.5] p-[1vw] font-light mobile:w-[150vw]">REORDER CODE</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw] ">
            <div className="flex-[0.5] p-[1vw] mobile:w-[200vw]">ADVAPELC-M</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[180vw] ">
            <div className="flex-[0.5] p-[1vw] mobile:w-[70vw]">ADVAPELC-L</div>
            <div className="flex-1 flex justify-between ">
              <div className="p-[1vw]  border-b border-[#DADADA] mobile:w-[60vw] mobile:flex  mobile:text-center mobile:justify-center mobile:items-center">
