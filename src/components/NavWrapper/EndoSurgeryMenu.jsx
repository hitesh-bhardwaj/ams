...
export default function EndoSurgeryMenu({ onBack }) {
  ...
  return (
    <div className="flex gap-5 items-start relative mobile:pt-[10vw]" ref={menuRef}>
      <div className='absolute left-[10%] top-[-2vw] mobile:top-[5vw] mobile:left-[20%]'> 
          <NavLink href="/endo" linkText="Endo Surgery" />
        </div>
        <button className="absolute top-[-2.2vw] mobile:top-[5vw] h-[2vw] w-[2vw] p-[0.5vw] tablet:w-8 tablet:h-8 tablet:p-1.5 mobile:h-8 mobile:w-8 mobile:p-1.5 flex items-center justify-center rounded-full border border-black/50 group hover:bg-black duration-300" onClick={onBack}>
      ...
      <div className='flex items-start gap-[3vw] pt-1 mobile:flex-col mobile:gap-[5vw] tablet:pt-7 mobile:pt-[5vw]'>
