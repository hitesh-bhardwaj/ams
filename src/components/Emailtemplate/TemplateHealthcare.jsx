...
const HealthCare = ({Country, Salutation, FirstName,LastName, Email,HospitalName, Message , ProductInterest, Speciality }) => {
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            You have a new contact form submission on the AMS website (Healthcare).
            <br />
          ...
          <Row style={row}>
            ...
            <Row style={row}>
              ...
              <Column style={{...columnText, textDecoration: "underline", color: "#067df7"}}>{Email}</Column>
            </Row>
