      ...
      <div className="w-full h-full ">
        <div className="absolute top-0 right-0 bottom-0 left-0 flex justify-between items-center  mobile:flex-col tablet:flex-col tablet:top-[22%]">
          <div className=" absolute left-[12%] top-[30%] mobile:left-[17%] mobile:w-[100%] tablet:left-[15%] mobile:top-[20%] tablet:top-[15%] z-[10]">
            <h1 data-para-anim
              className="text-white aeonik leading-[1] hero-text font-light mobile:mb-[4vw] overflow-hidden">
              <span
            ...
            <div className='flex items-center mt-[0.2vw] mobile:items-start'>
              <p className=" text-[1.1vw] uppercase font-light text-[#FFFFFF] leading-[1.2] tracking-wider mobile:text-[4.6vw]  mobile:w-[70%]  tablet:text-[3vw] tablet:max-w-[70%]  mobile:text-center mobile:justify-center z-[10] fadeUp">
