...
const KnotlessSpecifications = () => {
  ...
  <div data-lenis-prevent className="w-full text-[1.25vw] font-light py-[3vw] text-[#4A4A4A] overflow-y-auto mobile:text-[4.5vw] tablet:text-[2.5vw] mobile:overflow-x-scroll  mobile:py-[5vw] mobilepy-[4vw] tablet:py-[3.5vw]">
          <div className="flex w-full border-b border-[#DADADA]  mobile:w-[130vw]">
            <div className=" p-[1vw] w-[20vw] font-light tablet:w-[25vw] mobile:w-[50vw]"> Code</div>
          ...
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[130vw]">
            <div className=" p-[1vw] w-[20vw] tablet:w-[25vw] mobile:w-[50vw]">Max pressure</div>
            <div className=" flex justify-start gap-[21.5vw] mobile:gap-[25vw] ">
              <div className="p-[1vw]  ">500 PSI</div>
              <div className="p-[1vw]  ">500 PSI</div>
            </div>
          </div>
          <div className="flex w-full border-b border-[#DADADA] mobile:w-[130vw]">
            <div className=" p-[1vw] w-[20vw] tablet:w-[25vw] mobile:w-[50vw]">Shelf life</div>
            <div className=" flex justify-start gap-[22vw] mobile:gap-[26vw] ">
              <div className="p-[1vw]  ">3 Years</div>
              <div className="p-[1vw]  ">3 Years</div>
            </div>
          </div>
        </div>
...
export default KnotlessSpecifications